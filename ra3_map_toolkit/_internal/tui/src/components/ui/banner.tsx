// LOCAL PATCH: useInput is gated on isRawModeSupported + dismissible so the
// component can be rendered in non-TTY contexts. If you re-run
// `shadcn add @termcn/banner --overwrite`, re-apply this patch.
...
export const Banner = ({
  ...
  useInput(
    ...
    { isActive: dismissible && isRawModeSupported }
  );
