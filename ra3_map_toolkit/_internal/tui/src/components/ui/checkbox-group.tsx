// LOCAL PATCH: registry version had `input === ""` instead of `input === " "`,
// so space couldn't toggle items. Also added `a`/`n` for select-all/none, and
// `isActive` so it can be disabled. Re-apply if re-running shadcn add --overwrite.
