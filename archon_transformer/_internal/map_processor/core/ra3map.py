...
class Ra3Map:
    ...
    def __init__(self, map_path: str, config: Optional['ParserConfig'] = None):
        """
        Initialize Ra3Map.
        ...
        self._parser = Ra3MapParser(self.config)
        self._reconstructor = Ra3MapReconstructor(self.config)
